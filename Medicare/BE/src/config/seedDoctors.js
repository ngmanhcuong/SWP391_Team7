...
const buildRoomName = (roomCode, specialtyName) => `Phòng ${roomCode} - Khoa ${specialtyName}`;
...
const DOCTORS = [
  {
    ...
    roomCode: 'TM001',
    roomName: buildRoomName('TM001', 'Tim mạch'),
    isAvailable: true,
    avatarBg: 'rgba(218,226,255,0.3)',
  },
  {
    name: 'TS.BS. Trần Minh Bách',
  ...
  },
  {
    ...
    roomCode: 'TM002',
    roomName: buildRoomName('TM002', 'Tim mạch'),
    isAvailable: false,
  ...
  },
  {
    ...
    roomCode: 'XK001',
    roomName: buildRoomName('XK001', 'Cơ xương khớp'),
    isAvailable: true,
    avatarBg: 'rgba(218,226,255,0.3)',
  },
  {
    name: 'BSCKI. Hoàng Văn Đức',
  ...
  },
  {
    ...
    roomCode: 'XK002',
    roomName: buildRoomName('XK002', 'Cơ xương khớp'),
    isAvailable: true,
    avatarBg: 'rgba(130,249,190,0.3)',
  },
  {
    ...
    specialtySlug: 'obstetrics-pediatrics',
    rating: 4.9,
    reviewCount: 186,
    experienceYears: 16,
    tag: { label: 'Chuyên gia đầu ngành', variant: 'expert' },
    ...
    roomCode: 'SN001',
    roomName: buildRoomName('SN001', 'Sản & Nhi'),
    isAvailable: true,
    avatarBg: 'rgba(255,218,210,0.3)',
  },
  {
  ...
  },
  {
    ...
    roomCode: 'SN002',
    roomName: buildRoomName('SN002', 'Sản & Nhi'),
    isAvailable: true,
    avatarBg: 'rgba(130,249,190,0.3)',
  },
  {
    name: 'BSCKII. Phạm Hoàng Long',
    ...
    nextAvailableSlot: null,
    roomCode: 'MT001',
    roomName: buildRoomName('MT001', 'Mắt'),
    isAvailable: false,
    avatarBg: 'rgba(130,249,190,0.3)',
  },
  {
  ...
  },
  {
    ...
    roomCode: 'MT002',
    roomName: buildRoomName('MT002', 'Mắt'),
    isAvailable: true,
    avatarBg: 'rgba(255,218,210,0.3)',
  },
];
...
const seedDoctors = async () => {
  ...
  const bySlug = new Map(specialties.map((specialty) => [specialty.slug, specialty]));
