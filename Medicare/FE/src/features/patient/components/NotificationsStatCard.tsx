...
import { getStatTheme } from '../constants/statCardTheme';
...
const NotificationsStatCard: React.FC<NotificationsStatCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative flex items-center justify-center w-12 h-12 rounded-2xl ${theme.tile} ring-1 ${theme.ring} transition-transform duration-300 group-hover:scale-105`}
      >
      ...
      <div className="relative">
        ...
        <p className="text-3xl font-semibold text-[#191c1e] leading-10 tracking-tight mt-0.5">
          {stat.value}
        </p>
      </div>
    </button>
