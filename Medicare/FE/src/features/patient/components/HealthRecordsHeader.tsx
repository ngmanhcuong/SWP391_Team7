      ...
      <div className="relative flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1 text-xs font-medium text-white backdrop-blur-sm ring-1 ring-white/20">
            <FileHeart size={14} className="text-cyan-200" />
            Hồ sơ sức khỏe
          </div>
        ...
        <button
          type="button"
          onClick={onDownload}
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-[#1e40af] hover:bg-blue-50 transition-colors shrink-0 shadow-lg shadow-blue-900/20"
        >
          <Download size={16} />
          Tải hồ sơ PDF
        </button>
